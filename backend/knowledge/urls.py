...
from .views import (
    ...
    ExplorationContextEnvironmentalEventsView,
    ExplorationContextListCreateView,
    ExplorationContextLivingConditionsView,
    ExplorationContextProcessesView,
...
urlpatterns = [
    ...
    path(
        "historical-processes/<uuid:pk>/",
        HistoricalProcessDetailView.as_view(),
        name="historical-process-detail",
    ),
    path(
        "process-assertion-relations/",
        ProcessAssertionRelationListView.as_view(),
        name="process-assertion-relation-list",
    ),
    ...
    path(
        "exploration-contexts/<uuid:pk>/processes/",
        ExplorationContextProcessesView.as_view(),
        name="exploration-context-processes",
    ),
    path(
    ...
    path(
        "exploration-contexts/<uuid:pk>/environmental-events/",
        ExplorationContextEnvironmentalEventsView.as_view(),
        name="exploration-context-environmental-events",
    ),
